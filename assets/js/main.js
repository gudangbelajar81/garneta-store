...
Berdasarkan rincian di atas, untuk gajian periode ini kasbonnya mau *Dipotong Full (Lunas)* atau mau *Dicicil Sebagian* dulu?`;
  ...
  if (formPayroll) {
    formPayroll.onsubmit = async (e) => {
      ...
      const views = { dashboard, "neural-hub": neuralHub, barang, supplier, pembelian, ngitung, riwayat, kalkulator, penjualan, laporan, statistik, audit, users, gaji, settings, kasbon };
...
Minyak Goreng 3 45000"></textarea>
    ...
    window.ngitungPrintBluetooth = async function() {
      ...
      const KNOWN_PRINTER_UUIDS = [
        ...
        { svc: 'e7810a71-73ae-499d-8c15-faa9aef0c3f2', char: 'bef8d6c9-9c21-4c9e-b632-bd58c1009f9f' }, // Epson/Star
        { svc: '000018f0-0000-1000-8000-00805f9b34fb'.replace('18f0', '18f0'), char: '00002af1-0000-1000-8000-00805f9b34fb'.replace('2af1', '2af1') },
        { svc: '0000fee7-0000-1000-8000-00805f9b34fb', char: '0000fec8-0000-1000-8000-00805f9b34fb' }, // Qirui / Netum
        { svc: '6e400001-b5a3-f393-e0a9-e50e24dcca9e', char: '6e400002-b5a3-f393-e0a9-e50e24dcca9e' }, // Nordic UART (Eco 58D)
        { svc: '0000ff00-0000-1000-8000-00805f9b34fb', char: '0000ff02-0000-1000-8000-00805f9b34fb' }, // Xprinter
